...
motiffile <- system.file("extdata", as.character("x32.tab"), package = "motifcounter")
...
simdist <- motifcounter:::simulateNumHitsDist(motif, bg, regions, 100,
...
plot(0:(maxhits + 1), cpdist$dist[1:(maxhits + 2)], col = "blue", ylab = "Probability", 
  xlab = "Num. of hits")
points(0:(maxhits + 1), combdist$dist[1:(maxhits + 2)], col = "red")
points(0:(maxhits + 1), simdist$dist[1:(maxhits + 2)], col = "gray")
legend(50, 0.08, c("comp. Poiss.", "combinatorial", "empirical"), col = c("blue", 
  "red", "gray"), lty = c(1, 1, 1))
