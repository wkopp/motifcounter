...
motiffile <- system.file("extdata", 
    as.character("x32.tab"), package = "motifcounter")
...
**Note:** Scanning both DNA strands for motif hits (at $\alpha=0.001$) 
can only yield an even number of motif hits, as a hit on the forward 
