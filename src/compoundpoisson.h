...
double computePoissonParameterSingleStranded(int seqlen, int mlen, int maxclump, double alpha,double *theta);
...
void computeExtentionFactorsKoppSingleStranded(double *xi, double *beta, int mlen);
