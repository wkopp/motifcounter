...
void Rmotiffromfile(char **fmotif, double *pseudocount) {
    ...
    } else if (strcmp(&fmotif[0][strlen(fmotif[0])-strlen("transfac")], 
                "transfac")==0){
        mwidth=getTransfacMotifWidth(f);
    } else if (strcmp(&fmotif[0][strlen(fmotif[0])-strlen("jaspar")], 
                "jaspar")==0){
        mwidth=getJasparMotifWidth(f);
    //} else if (strcmp(&fmotif[0][strlen(fmotif[0])-strlen("meme")], 
    //"meme")==0){
